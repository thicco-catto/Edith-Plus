...
local EdithPlus = Characters.newCharacter("EdithPlus")
--[[
...
EdithPlus:AddCostume("edith_hoodie")
--[[
...
--EdithPlus:SetPocketItem(Card.CARD_MAGICIAN)
--[[
...
EdithPlus:SetStats(NormalStats)
...
EdithPlus:SetTrinket(TrinketType.TRINKET_SWALLOWED_PENNY, true)
...
EdithPlus:AddItem(CollectibleType.COLLECTIBLE_INNER_EYE, false, true) -- I want Sad Onion and give me the costume.
...
EdithPlus:SetPocketItem(PillEffect.PILLEFFECT_BAD_GAS, true, true) -- this is a pill, so the second option is true, and third option tells the template its the tainted variant
...
EdithPlus:SetStats(TaintedStats, true) -- true again at the end, getting the idea now?
